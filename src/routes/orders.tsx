...
function OrdersPage() {
  ...
  // ✅ Filter outside Zustand selector
    ...
    <AppShell>
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <p className="text-slate-500 mb-10">
          Track every order from payment to pickup.
        </p>
        ...
        {orders.length === 0 ? (
          <div className="rounded-2xl border border-slate-200 bg-white p-16 text-center">
            ...
            <Link
              to="/components"
              className="mt-6 inline-block rounded-lg bg-brand-navy text-white px-6 py-3 font-semibold hover:bg-slate-800"
            >
              Start browsing
            </Link>
          </div>
              ...
              >
                ...
                <div className="grid sm:grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-brand-navy">
                      {o.items.reduce((a, i) => a + i.quantity, 0)} units
                    </div>
                  </div>
